...
def basic_easy_mode(screen, switch_screen, font):
    ...
    color_map = {
        ...
        "naranja": (255, 165, 0),
        "morado": (128, 0, 128),
        "checker_blanco": (200, 200, 200),  # Changed to a light gray
        "checker_aqua": (0, 200, 255),      # Changed from (0, 255, 255) to (0, 200, 255)
        "checker_rosa": (255, 182, 193),     # Changed from (255, 192, 203) to (255, 182, 193)
        "checker_naranja": (255, 140, 0)     # Changed from (255, 165, 0) to (255, 140, 0)
    }
